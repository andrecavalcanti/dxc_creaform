page 50001 "DXCProductionForecastMatrix"
{
    // version NAVW111.00.00.19846

    CaptionML = ENU='Production Forecast Matrix',
                ESM='Matriz prev. producción',
                FRC='Matrice Prévision production',
                ENC='Production Forecast Matrix';
            ...
            repeater(Control1)
            {
                ...
                field(Description;Description)
                {
                    ...
                    ToolTipML = ENU='Specifies a description of the item.',
                                ESM='Especifica una descripción del producto.',
                                FRC='Spécifie une description de l''élément.',
    ...
    var
        ...
        LocationFilter : Text;
        DateFilter : Text;
        Text000 : TextConst ENU='The Forecast On field must be Sales Items or Component.',ESM='La previsión en el campo debe ser Productos venta o Componentes',FRC='La prévision du champ doit être un article vente ou une composante.',ENC='The Forecast On field must be Sales Items or Component.';
        Text001 : TextConst Comment='A forecast was previously made on the 01-10-11. Do you want all forecasts of the period 12/02/2012-12/03/2012 moved to the start of the period?',ENU='A forecast was previously made on the %1. Do you want all forecasts of the period %2-%3 moved to the start of the period?',ESM='Una previsión ha sido hecha en  %1. ¿Quiere que todas las previsiones del periodo %2-%3 sean movidas al principio del periodo?',FRC='Une prévision a déjà été établie pour %1. Voulez-vous déplacer toutes les prévisions de la période %2-%3 au début de la période?',ENC='A forecast was previously made on the %1. Do you want all forecasts of the period %2-%3 moved to the start of the period?';
        Text003 : TextConst ENU='You must set a location filter.',ESM='Debe definir un filtro de almacén.',FRC='Vous devez définir un filtre emplacement.',ENC='You must set a location filter.';
        Text004 : TextConst ENU='You must change view to Sales Items or Component.',ESM='Debe cambiar la vista a Productos venta o Componente.',FRC='Vous devez basculer en visualisation Articles vente ou Composante.',ENC='You must change view to Sales Items or Component.';
        [InDataSet]
